...
- **Preprocessing:** Manual annotation, OCR/ASR for text extraction, video quality assessment (NIQE), and emotion analysis.  
...
- Changing some models (e.g. viggish) into tensorflow version.  
...
## **Metrics**  
- Planned Experiments:
Evaluate our tensorflow version SV-FEND against existing SV-FEND on original FakeSV dataset, measuring and comparing accuracy, F1-score, precision, and recall.
